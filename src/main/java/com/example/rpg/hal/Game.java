...
public class Game {
    ...
    public static List<Fighter> fighters = new ArrayList<>();
    ...
    public void startNextFighterTurn() {
        ...
        if (this.heroes.size() == 0) {
            ...
            if (this.currentFighter instanceof Hero) {
                ...
                //    sous-classe "Hero".
                this.status = Status.HERO_TURN;
            } else {
                this.status = Status.ENEMY_TURN;
            }
    ...
    public void startEnemyTurn() {
        ...
        Hero hero = this.heroes.get(0); //--> 1 seul héro pour l'instant...
